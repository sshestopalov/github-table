...
export type RepositoryStatsFragment = { __typename?: "Repository" } & Pick<
  Repository,
    ...
    edges: Maybe<
      Array<
        { __typename?: "SearchResultItemEdge" } & Pick<
          ...
          "cursor"
        > & {
            node: { __typename?: "Repository" } & RepositoryStatsFragment;
          }
      >
    >;
  };
...
export const RepositoryStatsFragmentDoc = gql`
...
export function useSearchRepositoriesQuery(
  ...
  return Apollo.useQuery<
    SearchRepositoriesQuery,
    SearchRepositoriesQueryVariables
  >(SearchRepositoriesDocument, baseOptions);
}
